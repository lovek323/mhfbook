...
\index{Vectors}
\index{Deductive geometry}
\index{geometry, Deductive}
\index{Trigonometry}
\index{Applications of trigonometry}
\index{trigonometry, Applications of}
\index{Law of sines}
\index{sines, Law of}
\index{Law of cosines}
\index{cosines, Law of}
...
\begin{figure}[h]\caption{}\label{231.fig1}\begin{center}\includegraphics[scale=0.5,type=eps,ext=.eps,read=.eps]{asy/231.fig1.asy}\end{center}\end{figure}

Figure \vref{231.fig2} shows the triangle in question not drawn to scale to make it easier to read.

\begin{figure}[h]\caption{}\label{231.fig2}\begin{center}\includegraphics[scale=0.5,type=eps,ext=.eps,read=.eps]{asy/231.fig2.asy}\end{center}\end{figure}
